...
describe('mutations', () => {
  ...
  it('should add a contact', () => {
    ...
    cy.url().should('equal', 'http://localhost:1336/admin/add');
    ...
    cy.url().should('equal', 'http://localhost:1336/admin/');
  });
  ...
  it('should edit a contact', () => {
    ...
    cy.url().should('equal', 'http://localhost:1336/admin/edit/89222b2d-8d06-41ff-82cf-c989dd90de24');
